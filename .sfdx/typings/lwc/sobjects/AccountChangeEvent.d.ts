...
declare module "@salesforce/schema/AccountChangeEvent.Business_Hours__c" {
  const Business_Hours__c:string;
  export default Business_Hours__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Time_Zone__c" {
  const Time_Zone__c:string;
  export default Time_Zone__c;
}
